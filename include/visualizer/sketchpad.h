...
class Sketchpad {
 public:
  ...
  /**
   * Gets pixel states of board.
   */
  std::vector<std::vector<bool>> GetPixelState();
 ...
 private:
  ...
  /** Vector representing pixels that are shaded on board */
  std::vector<std::vector<bool>> pixel_state_;
